      ...
      <table class="table table-striped">
        ...
        <tbody>
          <tr ng-repeat = "row in filteredData = ( data | filter:formatedDt | filter:query | orderBy: '-dateTime') ">
            ...
            href="?action=edit&id={{row.id}}"> <i class="glyphicon glyphicon-pencil"></i> </a>
            <a ng-click="click(row)" title="addFriends" class="btn btn-primary btn-sm toggle-modal addFriends" data-target="#myModal"
            href="?action=addFriends&id={{row.id}}"> <!-- <i class="glyphicon glyphicon-trash"></i>  --></a></td>
